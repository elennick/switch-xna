...
namespace Switch
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public SpriteFont LittleFont
        {
            get { return littleFont; }
        }
        ...
        protected override void LoadContent()
        {
            ...
            font = content.Load<SpriteFont>("Fonts\\PhillySansFont");
            littleFont = content.Load<SpriteFont>("Fonts\\ScoreMessageBoxFont");
            bigFont = content.Load<SpriteFont>("Fonts\\ScoreFont");
            blankTexture = content.Load<Texture2D>("blank");

            selectorImage = content.Load<Texture2D>("Sprites\\Tiles\\TileSet1\\Objects\\cap_top");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                //sometimes this gets thrown while loading the main menu? need to fix this
            }
        }
